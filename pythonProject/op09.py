...
def help_message(message):
    bot.reply_to(message, f"Hello, {message.from_user.first_name}!\nI'm a bot that answers you with OpenAI.\n "
                          ...
                          f"Also you can use /start command to get facts and task\n"
                          f"And you can use /record command to record audio, bat I'm just learning how to convert voice to text\n"
                          f"And you can use /fact command to get current time and receive facts about water\n"
                          f"And you can use /task command to get daily task for learning English\n"
...
def chat_with_ai(message):
    ...
    if language_message == "en":
        ...
        tts = gTTS(text=assistant_response, lang='en')  # Используем русский язык
